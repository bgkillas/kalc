...
# issues
- likely to fix: sum(a,a,2,3) does not work as 'a' is ignored for not being a function name, so you need to use sum/cos, i cant think of a way to do this without losing functionality
