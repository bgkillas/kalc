        ...
        if d2_or_d3.0
        {
            ...
            if options.lines || lines
            {
                fg.axes2d()
                    ...
                    .set_x_label(if options.flat { "re" } else { "x" }, &[])
                    .set_y_label(if options.flat { "im" } else { "y" }, &[])
        ...
        if d2_or_d3.1
        {
                ...
                && (points3d[0][0][2].is_empty() || points3d[0][1][2].is_empty())
            {
                fg.axes3d()
                    ...
                    .set_x_label("x", &[])
                    .set_y_label(if options.depth { "re" } else { "y" }, &[])
                    .set_z_label(if options.depth { "im" } else { "z" }, &[])
