...
fn ec(prec: (u32, u32)) -> Variable
{
    Variable {
        name: vec!['e', 'c'],
        parsed: vec![Num(Number::from_units(
...
)
{
        ...
        if phi1 || phi2
        {
            ...
            if phi1
            {
                ...
                vars.insert(
                    ...
                    Variable {
                        name: vec!['p', 'h', 'i'],
                        parsed: vec![Num(Number::from_units(phi.clone().into(), None))],
                        unparsed: String::new(),
                        funcvars: Vec::new(),
                    },
                );
            ...
            if phi2
            {
                ...
                vars.push(Variable {
                    name: vec!['φ'],
                    parsed: vec![Num(Number::from_units(phi.into(), None))],
                    unparsed: String::new(),
                    funcvars: Vec::new(),
                });
            }
        ...
        if pi1 || pi2 || tau1 || tau2
        {
            ...
            if pi1
            {
                ...
                vars.insert(
                    ...
                    Variable {
                        name: vec!['p', 'i'],
                        parsed: vec![Num(Number::from_units(pi.clone().into(), None))],
                        unparsed: String::new(),
                        funcvars: Vec::new(),
                    },
                );
            ...
            if tau1 || tau2
            {
                ...
                if tau1
                {
                    ...
                    vars.insert(
                        ...
                        Variable {
                            name: vec!['t', 'a', 'u'],
                            parsed: vec![Num(Number::from_units(tau.clone().into(), None))],
                            unparsed: String::new(),
                            funcvars: Vec::new(),
                        },
                    );
                ...
                if tau2
                {
                    ...
                    vars.push(Variable {
                        name: vec!['τ'],
                        parsed: vec![Num(Number::from_units(tau.into(), None))],
                        unparsed: String::new(),
                        funcvars: Vec::new(),
                    });
                }
    ...
    if args.contains('e') && !blacklist.contains(&"e".to_string())
    {
        ...
        vars.push(Variable {
            name: vec!['e'],
            parsed: vec![Num(Number::from_units(e.into(), None))],
            unparsed: String::new(),
            funcvars: Vec::new(),
        });
    }
...
pub fn get_vars(options: Options) -> Vec<Variable>
{
    ...
    vec![
        ...
        Variable {
            name: vec!['π'],
            parsed: vec![Num(Number::from_units(pi.into(), None))],
            unparsed: String::new(),
            funcvars: Vec::new(),
        },
        Variable {
