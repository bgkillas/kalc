        ...
        if phi1 || phi2
        {
            ...
            if phi1
            {
                ...
                vars.insert(
                    ...
                    Variable {
                        name: vec!['p', 'h', 'i'],
                        parsed: vec![Num((phi.clone().into(), None))],
                        unparsed: String::new(),
                        funcvars: Vec::new(),
                    },
                );
        ...
        if pi1 || pi2 || tau1 || tau2
        {
            ...
            if pi1
            {
                ...
                vars.insert(
                    ...
                    Variable {
                        name: vec!['p', 'i'],
                        parsed: vec![Num((pi.clone().into(), None))],
                        unparsed: String::new(),
                        funcvars: Vec::new(),
                    },
                );
            ...
            if tau1 || tau2
            {
                ...
                if tau1
                {
                    ...
                    vars.insert(
                        ...
                        Variable {
                            name: vec!['t', 'a', 'u'],
                            parsed: vec![Num((tau.clone().into(), None))],
                            unparsed: String::new(),
                            funcvars: Vec::new(),
                        },
                    );
